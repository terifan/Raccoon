...
//		Log.LEVEL = 10;
		...
		SecureBlockDevice secureBlockDevice = SecureBlockDevice.create(memoryDevice, new AccessCredentials("password").setIterationCount(100));
		...
		else
		{
			...
			assertEquals(bp.unmarshal(tmp).getBlockType(), aIndirect ? BlockType.DIR : BlockType.DATA);
