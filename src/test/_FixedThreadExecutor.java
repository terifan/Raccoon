 ...
 */
public class _FixedThreadExecutor<T> implements AutoCloseable
{
	 ...
	 */
	public _FixedThreadExecutor(int aNumThreads)
	{
		if (aNumThreads > 0)
		{
...
//					}
	 ...
	 */
	public _FixedThreadExecutor<T> setQueueSizeLimit(int aQueueSizeLimit)
	{
	...
	public _FixedThreadExecutor<T> setOnCompletion(OnCompletion aOnCompletion)
	{
