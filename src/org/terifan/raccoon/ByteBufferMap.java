 ...
 * [list of entries] (entry 1..n)
 *   2 bytes - key length
 *   2 bytes - value length
 *   n bytes - key n bytes - value
 * [free space]
 *   n bytes - zeros
 * [list of pointers]
 *   n * 4 bytes - offset (pointer 1..n)
 */
public class ByteBufferMap implements Iterable<ArrayMapEntry>, FormattedToString
{
...
//			System.out.println(mIndex+" "+entry);
	...
	public ByteBufferMap resize(int aNewCapacity)
	{
	...
	public ByteBufferMap[] split(int aCapacity)
	{
		ByteBufferMap low = new ByteBufferMap(aCapacity);
		ByteBufferMap high = new ByteBufferMap(aCapacity);
		...
		return new ByteBufferMap[]{low, high};
	}
